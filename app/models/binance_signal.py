...
class BinanceSignal(Base, TimestampMixin):
    __tablename__ = "binance_signals"
    ...
    executions: Mapped[list["Execution"]] = relationship(
        back_populates="binance_signal",
        foreign_keys="[Execution.binance_signal_id]",
        cascade="all, delete-orphan",
    )

    __table_args__ = (
        Index("ix_binance_signals_status_created", "status", "created_at"),
    )
